...
@PropertyComputer
public class XNoOfReferencesToClassInProject implements IPropertyComputer<Double, MClass>{
	...
	public Double compute(MClass mClass) {
		...
		IJavaElement[] elements = (IJavaElement[]) Collections.singletonList(iJavaProject).toArray();
