...
public class NoOfSubClassesOfClassInProject extends MetricInterface {
	 ...
	 * 
	 * @return Double: the total number of classes in project which extend the current
	 *          class
	 */
	...
	public double calculateMetric(ArrayList<Object> source, ArrayList<Object> destination) {
		...
		return mClass.xNoOfSubClassesOfClassInProject();
	}
}
