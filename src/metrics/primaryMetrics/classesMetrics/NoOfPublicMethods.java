...
public class NoOfPublicMethods extends MetricInterface {
	 ...
	 * 
	 * @return Double: the total number of public methods in the class given as a
	 *          parameter
	 */
	...
	public double calculateMetric(ArrayList<Object> source, ArrayList<Object> destination) {
		...
		return mClass.xNoOfPublicMethods();
	}
