...
public class NoOfInterfacesInPackage extends MetricInterface{
	 ...
	 * 
	 * @return Double: the number of interfaces in the given package
	 */
	...
	public double calculateMetric(ArrayList<Object> source, ArrayList<Object> destination) {
		...
		return mPackage.xNoOfInterfacesInPackage();
	}
