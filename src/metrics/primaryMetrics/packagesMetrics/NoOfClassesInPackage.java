...
public class NoOfClassesInPackage extends MetricInterface{
	 ...
	 * 
	 * @return Double: the number of classes in the given package
	 */
	...
	public double calculateMetric(ArrayList<Object> source, ArrayList<Object> destination) {
		...
		return mPackage.xNoOfClassesInPackage();
	}
}
